      ...
      <div className="mb-8 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
        ...
        {isConnected && address && (
          <div className="flex flex-col items-start lg:items-end gap-1">
            <div className="flex flex-col lg:flex-row lg:items-center gap-2 bg-slate-700/50 px-3 py-1.5 rounded-lg flex-wrap">
            ...
            {walletMode === 'flash' && (
              <span className="text-xs text-slate-500 text-left lg:text-right">
